...
class Steganography(object):
    ...
    def _make_payload(self, width, height, depth, text):
        ...
        image1 = torch.FloatTensor(payload).view(1, depth, height, width)
        return image1
...
class Steganography(object):
    ...
    def encode(self, cover, output, text):
        ...
        Args:
            ...
            text (str): Message to hide inside the image.
        """
        cover = imageio.v2.imread(cover, pilmode='RGB') / 127.5 - 1.0
        cover = torch.FloatTensor(cover).permute(2, 1, 0).unsqueeze(0)
        ...
        #print('ssim of the model : ',ssim(cover,generated))

        generated = (generated.permute(2, 1, 0).detach().cpu().numpy() + 1.0) * 127.5
        imwrite(output, generated.astype('uint8'))

        #print('ssim of the model : ', ssim(payload,generated))
...
#steganography = steganography.load(path='basic_100.steg')
...
# print("Encoding data")
# print("\r")
# steganography.encode('input.png', 'output.png', str(data))
...
data = input("Enter data:")
print("\r")
coverimage = input("Enter the path of the cover image:")
print("\r")
print("Encoding data")
print("\r")
steganography.encode(coverimage, 'output.png', str(data))
print("Encoded data and output image generated")
print("\r")
